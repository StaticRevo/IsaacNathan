    ...
    <SafeAreaView style={styles.safeArea}>
      <Header
        onProfilePress={() => {
          ...
          router.push('/profile' as any); // Navigate to Profile screen
        }}
      />
            ...
            {categories.map((category) => (
              <CategoryItem
                ...
                onPress={() => {
                  ...
                  router.push(`/category/${category.name.toLowerCase()}` as any); // Navigate to specific category
                }}
              />
            ))}
          </ScrollView>
